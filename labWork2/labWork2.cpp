...
Результат выдать в виде таблицы, состоящей из 3 столбцов: 
1 - значение аргумента из заданного диапазона; 
2 - значение функции, вычисленное с помощью представления в ряд; 
3 - значение функции, к которой сходится ряд, вычисленное с помощью библиотечных функций.*/
